...
import * as controladorUsuario from '../controlador/usuarioControlador';
...
router.post('/:email/grupo=:grupo/estab=:estab', passport.authenticate('jwt', { session: false }), controladorUsuario.votaRestaurante);
